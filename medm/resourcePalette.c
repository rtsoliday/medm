...
static void createBundleButtons(Widget messageF)
{
  ...
  n = 0;
  XtSetArg(args[n], XmNlabelString, xmstringSelect);
  n++;
      ...
      if (openFSD == NULL)
        {
          ...
          XtSetArg(args[n], XmNdirMask, label);
          n++;
...

          {
            ...
            wm_delete_window = XmInternAtom(XtDisplay(resourceFilePDM), "WM_DELETE_WINDOW", False);
            XmAddWMProtocolCallback(XtParent(openFSD), wm_delete_window, fileOpenCallback, openFSD);
          }
...
void textFieldNumericVerifyCallback(Widget w, XtPointer clientData, XtPointer callData)
{
  ...
  if (!abort)
    ...
    print("  +/- not in first position\n");
  else if (abort == 2)
    print("  More than one new dot\n");
  else if (abort == 3)
    print("  Already have a dot\n");
  else if (abort == 4)
...
void textFieldActivateCallback(Widget w, XtPointer cd, XtPointer cbs)
{
  ...
  switch (rcType)
    ...
    case YLABEL_RC:
      ...
      break;
    case Y2LABEL_RC:
      strcpy(globalResourceBundle.y2label, stringValue);
      break;
    case Y3LABEL_RC:
      strcpy(globalResourceBundle.y3label, stringValue);
      break;
    case Y4LABEL_RC:
      strcpy(globalResourceBundle.y4label, stringValue);
      break;
    case LINEWIDTH_RC:
...
void textFieldLosingFocusCallback(Widget w, XtPointer cd, XtPointer cbs)
{
  ...
  print("\ntextFieldLosingFocusCallback: rcType=%d[%s]\n",
        rcType,
        (rcType >= 0 && rcType < MAX_RESOURCE_ENTRY) ? resourceEntryStringTable[rcType] : "Unknown");
#endif
  ...
  switch (rcType)
    ...
    case YLABEL_RC:
      ...
      break;
    case Y2LABEL_RC:
      newString = globalResourceBundle.y2label;
      break;
    case Y3LABEL_RC:
      newString = globalResourceBundle.y3label;
      break;
    case Y4LABEL_RC:
      newString = globalResourceBundle.y4label;
      break;
    case VIS_CALC_RC:
...
void initializeGlobalResourceBundle()
{
  ...
  globalResourceBundle.y2label[0] = '\0';
  globalResourceBundle.y3label[0] = '\0';
  globalResourceBundle.y4label[0] = '\0';
  ...
  for (i = 0; i < MAX_TRACES; i++)
    {
      ...
      if (i)
        {
          globalResourceBundle.cpData[i].yaxis = 1;
          globalResourceBundle.cpData[i].yside = 1;
        }
      else
        {
          globalResourceBundle.cpData[i].yaxis = 0;
          globalResourceBundle.cpData[i].yside = 0;
        }
    }
  ...
  globalResourceBundle.axis[Y1_AXIS_ELEMENT] = globalResourceBundle.axis[X_AXIS_ELEMENT];
  globalResourceBundle.axis[Y2_AXIS_ELEMENT] = globalResourceBundle.axis[X_AXIS_ELEMENT];
  globalResourceBundle.axis[Y3_AXIS_ELEMENT] = globalResourceBundle.axis[X_AXIS_ELEMENT];
  globalResourceBundle.axis[Y4_AXIS_ELEMENT] = globalResourceBundle.axis[X_AXIS_ELEMENT];
...
void createResource()
{
  ...
  n = 0;
  XtSetArg(args[n], XtNiconName, "Resources");
  n++;
  XtSetArg(args[n], XmNautoUnmanage, False);
  n++;
  XtSetArg(args[n], XtNtitle, "Resource Palette");
  n++;
  ...
  n = 0;
  XtSetArg(args[n], XmNbuttonCount, N_FILE_MENU_ELES);
  n++;
  XtSetArg(args[n], XmNbuttons, buttons);
  n++;
  XtSetArg(args[n], XmNbuttonType, buttonType);
  n++;
  XtSetArg(args[n], XmNbuttonMnemonics, keySyms);
  n++;
  XtSetArg(args[n], XmNpostFromButton, FILE_BTN_POSN);
  n++;
  ...
  buttonType[2] = XmPUSHBUTTON;
  n = 0;
  XtSetArg(args[n], XmNbuttonCount, N_BUNDLE_MENU_ELES);
  n++;
  XtSetArg(args[n], XmNbuttons, buttons);
  n++;
  XtSetArg(args[n], XmNbuttonType, buttonType);
  ...
  XtSetArg(args[n], XmNbuttonMnemonics, keySyms);
  n++;
  XtSetArg(args[n], XmNpostFromButton, BUNDLE_BTN_POSN);
  n++;
  XtSetArg(args[n], XmNsimpleCallback,
           bundleMenuSimpleCallback);
  n++;
  ...
  for (i = MIN_RESOURCE_ENTRY; i < MAX_RESOURCE_ENTRY; i++)
    {
      ...
      if (i == CHAN_A_RC || i == CHAN_B_RC || i == CHAN_C_RC || i == CHAN_D_RC || i == RDBK_RC || i == CTRL_RC || i == TRIGGER_RC || i == ERASE_RC || i == COUNT_RC)
        {
      ...
      else if (i == MSG_LABEL_RC || i == PRESS_MSG_RC || i == RELEASE_MSG_RC || i == TEXTIX_RC || i == TITLE_RC || i == XLABEL_RC || i == YLABEL_RC || i == Y2LABEL_RC || i == Y3LABEL_RC || i == Y4LABEL_RC || i == IMAGE_NAME_RC)
        {
...
static void createEntryRC(Widget parent, int rct)
{
  ...
  switch (rcType)
    ...
    case PATH_RC:
      ...
      n++;
      XtSetArg(args[n], XmNmaximum, 360);
      n++;
      ...
      XtSetArg(args[n], XmNorientation, XmHORIZONTAL);
      n++;
      XtSetArg(args[n], XmNscaleMultiple, 15);
      n++;
    ...
    case ALIGN_RC:
      ...
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_TEXT_ALIGN]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_TEXT_ALIGNS);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
      XtSetArg(args[n], XmNuserData, rcType);
      n++;
    ...
    case FORMAT_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_TEXT_FORMAT]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_TEXT_FORMATS);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case LABEL_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_LABEL_TYPE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_LABEL_TYPES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case DIRECTION_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_DIRECTION]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_DIRECTIONS);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case CLRMOD_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_COLOR_MODE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_COLOR_MODES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case FILLMOD_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_FILL_MODE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_FILL_MODES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case STYLE_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_EDGE_STYLE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_EDGE_STYLES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case FILL_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_FILL_STYLE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_FILL_STYLES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case VIS_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_VISIBILITY_MODE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_VISIBILITY_MODES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case UNITS_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_TIME_UNIT]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_TIME_UNITS);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case CSTYLE_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_CARTESIAN_PLOT_STYLE]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_CARTESIAN_PLOT_STYLES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case ERASE_OLDEST_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_ERASE_OLDESTS);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case ERASE_MODE_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_ERASE_MODES);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case STACKING_RC:
      ...
      XtSetArg(args[n], XmNbuttonType, buttonType);
      n++;
      XtSetArg(args[n], XmNbuttons, &(xmStringValueTable[FIRST_STACKING]));
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_STACKINGS);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case IMAGE_TYPE_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttons,
               &(xmStringValueTable[FIRST_IMAGE_TYPE]));
      n++;
    ...
    case RD_VISUAL_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_RD_VISUAL);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
    ...
    case GRID_SNAP_RC:
      ...
      n++;
      XtSetArg(args[n], XmNbuttonCount, NUM_BOOLEAN);
      n++;
      XtSetArg(args[n], XmNsimpleCallback,
               optionMenuSimpleCallback);
      n++;
      ...
      if (rcType == CLR_RC)
        {
          XtSetArg(args[n], XmNbackground,
                   (cdi == NULL) ? BlackPixel(display, screenNum) : cdi->colormap[cdi->drawingAreaForegroundColor]);
          n++;
        }
      else
        {
          XtSetArg(args[n], XmNbackground,
                   (cdi == NULL) ? WhitePixel(display, screenNum) : cdi->colormap[cdi->drawingAreaBackgroundColor]);
          n++;
        }
    ...
    case LIMITS_RC:
      n = 0;
      XtSetArg(args[n], XmNlabelString, dlXmStringMoreToComeSymbol);
      n++;
  ...
  while (arg >= 0)
    {
      switch (arg)
        ...
        case Y2LABEL_RC:
          {
            char *pvalue = va_arg(ap, char *);
            strcpy(pvalue, pRB->y2label);
            break;
          }
        case Y3LABEL_RC:
          {
            char *pvalue = va_arg(ap, char *);
            strcpy(pvalue, pRB->y3label);
            break;
          }
        case Y4LABEL_RC:
          {
            char *pvalue = va_arg(ap, char *);
            strcpy(pvalue, pRB->y4label);
            break;
          }
        case CLR_RC:
          {
            ...
            for (i = 0; i < MAX_TRACES; i++)
              {
                ...
                ptrace[i].yside = pRB->cpData[i].yside;
              }
            break;
          }
        case SCDATA_RC:
        ...
        case CPAXIS_RC:
          {
            ...
            paxis[Y3_AXIS_ELEMENT] = pRB->axis[Y3_AXIS_ELEMENT];
            paxis[Y4_AXIS_ELEMENT] = pRB->axis[Y4_AXIS_ELEMENT];
            break;
          }
        case TRIGGER_RC:
          {
...
void setResourcePaletteEntries()
{
  ...
  if ((cdi->selectedDlElementList->count == 1) &&
      ...
      (FirstDlElement(cdi->selectedDlElementList)->structure.element->structure.polyline->nPoints == 2))
    displayType = DL_Line;
    ...
    case DL_CartesianPlot:
      {
        ...
        XmTextFieldSetString(resourceEntryElement[YLABEL_RC],
                             globalResourceBundle.ylabel);
        strcpy(globalResourceBundle.y2label, p->plotcom.y2label);
        XmTextFieldSetString(resourceEntryElement[Y2LABEL_RC],
                             globalResourceBundle.y2label);
        strcpy(globalResourceBundle.y3label, p->plotcom.y3label);
        XmTextFieldSetString(resourceEntryElement[Y3LABEL_RC],
                             globalResourceBundle.y3label);
        strcpy(globalResourceBundle.y4label, p->plotcom.y4label);
        XmTextFieldSetString(resourceEntryElement[Y4LABEL_RC],
                             globalResourceBundle.y4label);
        globalResourceBundle.clr = p->plotcom.clr;
        XtVaSetValues(resourceEntryElement[CLR_RC], XmNbackground,
                      cdi->colormap[globalResourceBundle.clr], NULL);
        globalResourceBundle.bclr = p->plotcom.bclr;
        ...
        for (i = 0; i < MAX_TRACES; i++)
          {
            ...
            globalResourceBundle.cpData[i].yside = p->trace[i].yside;
          }
        for (i = X_AXIS_ELEMENT; i <= Y4_AXIS_ELEMENT; i++)
          {
