...
inline void DisplayWindow::resizeEvent(QResizeEvent *event)
{
...
inline HeatmapRotation DisplayWindow::parseHeatmapRotation(
    const QString &value) const
{
  const QString normalized = value.trimmed().toLower();
