...
ResourcePaletteDialog::ResourcePaletteDialog(const QPalette &basePalette, const QFont &labelFont,
    const QFont &valueFont, QWidget *parent)
  : QDialog(parent)
...
void ResourcePaletteDialog::showForDisplay(std::function<QRect()> geometryGetter,
...
void ResourcePaletteDialog::showForMultipleSelection()
{
  clearSelectionState();
...
void ResourcePaletteDialog::refreshGeometryFromSelection()
{
...
void ResourcePaletteDialog::refreshDisplayControls()
{
...
void ResourcePaletteDialog::showForText(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
...
void ResourcePaletteDialog::showForTextEntry(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForSetpointControl(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForTextArea(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForSlider(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForWheelSwitch(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForChoiceButton(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForMenu(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForMessageButton(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForShellCommand(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForRelatedDisplay(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForPvTable(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForWaveTable(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForTextMonitor(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForMeter(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForBarMonitor(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForThermometer(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForScaleMonitor(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForStripChart(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
...
void ResourcePaletteDialog::showForCartesianPlot(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QString()> titleGetter,
    std::function<void(const QString &)> titleSetter,
    std::function<QString()> xLabelGetter,
...
void ResourcePaletteDialog::showForByteMonitor(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForLedMonitor(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForExpressionChannel(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForComposite(std::function<QRect()> geometryGetter,
  std::function<void(const QRect &)> geometrySetter,
  std::function<QColor()> foregroundGetter,
  std::function<void(const QColor &)> foregroundSetter,
  std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForRectangle(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
...
void ResourcePaletteDialog::showForImage(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
...
void ResourcePaletteDialog::showForHeatmap(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QString()> titleGetter,
    std::function<void(const QString &)> titleSetter,
...
void ResourcePaletteDialog::showForWaterfall(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> foregroundGetter,
    std::function<void(const QColor &)> foregroundSetter,
    std::function<QColor()> backgroundGetter,
...
void ResourcePaletteDialog::showForLine(std::function<QRect()> geometryGetter,
    std::function<void(const QRect &)> geometrySetter,
    std::function<QColor()> colorGetter,
    std::function<void(const QColor &)> colorSetter,
    std::function<RectangleLineStyle()> lineStyleGetter,
...
void ResourcePaletteDialog::openCartesianAxisDialogForElement(CartesianPlotElement *element)
{
  if (!element) {
    return;
  }
...
void ResourcePaletteDialog::closeEvent(QCloseEvent *event)
{
  clearSelectionState();
...
int ResourcePaletteDialog::tableFontSizeValue(int value) const
{
...
int ResourcePaletteDialog::defaultTableFontSize() const
{
...
QLineEdit *ResourcePaletteDialog::createLineEdit()
{
...
QPushButton *ResourcePaletteDialog::createColorButton(const QColor &color)
{
...
QPushButton *ResourcePaletteDialog::createActionButton(const QString &text)
{
...
QComboBox *ResourcePaletteDialog::createBooleanComboBox()
{
...
QSpinBox *ResourcePaletteDialog::createFontSizeSpinBox()
{
...
void ResourcePaletteDialog::addRow(QGridLayout *layout, int row, const QString &label,
    QWidget *field)
{
...
bool ResourcePaletteDialog::eventFilter(QObject *object, QEvent *event)
{
...
void ResourcePaletteDialog::setColorButtonColor(QPushButton *button, const QColor &color)
{
...
void ResourcePaletteDialog::resetLineEdit(QLineEdit *edit)
{
  if (!edit) {
    return;
  }
...
void ResourcePaletteDialog::resetColorButton(QPushButton *button)
{
  if (!button) {
    return;
  }
...
void ResourcePaletteDialog::updateSectionVisibility(SelectionKind kind)
{
  if (geometrySection_) {
...
void ResourcePaletteDialog::commitTextString()
{
  if (!textStringEdit_) {
    return;
  }
...
void ResourcePaletteDialog::revertTextString()
{
  if (!textStringEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextVisibilityCalc()
{
  if (!textVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextChannel(int index)
{
...
void ResourcePaletteDialog::updateImageChannelDependentControls()
{
...
void ResourcePaletteDialog::updateHeatmapDimensionControls()
{
...
void ResourcePaletteDialog::updateWaterfallDependentControls()
{
...
void ResourcePaletteDialog::updateLineChannelDependentControls()
{
  bool hasChannelA = false;
...
void ResourcePaletteDialog::updateTextChannelDependentControls()
{
  bool hasChannelA = false;
...
void ResourcePaletteDialog::updateRectangleChannelDependentControls()
{
  bool hasChannelA = false;
...
void ResourcePaletteDialog::updateThermometerChannelDependentControls()
{
  bool hasChannelA = false;
...
void ResourcePaletteDialog::refreshLedMonitorColorButtons()
{
  if (ledOnColorButton_) {
...
void ResourcePaletteDialog::applyBinaryLedPreset()
{
...
void ResourcePaletteDialog::updateLedMonitorStateColorControls()
{
...
void ResourcePaletteDialog::updateLedMonitorChannelDependentControls()
{
...
void ResourcePaletteDialog::updateCompositeChannelDependentControls()
{
  bool hasChannelA = false;
...
void ResourcePaletteDialog::setFieldEnabled(QWidget *field, bool enabled)
{
  if (!field) {
    return;
  }
...
void ResourcePaletteDialog::updateTextAreaDependentControls()
{
  bool wordWrap = true;
...
void ResourcePaletteDialog::commitTextEntryChannel()
{
  if (!textEntryChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitSetpointControlLabel()
{
  if (!setpointControlLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitSetpointControlSetpoint()
{
  if (!setpointControlSetpointEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitSetpointControlReadback()
{
  if (!setpointControlReadbackEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitSetpointControlTolerance()
{
  if (!setpointControlToleranceEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextAreaChannel()
{
  if (!textAreaChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextAreaWrapColumnWidth()
{
  if (!textAreaWrapColumnWidthEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextAreaTabWidth()
{
  if (!textAreaTabWidthEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextAreaFontFamily()
{
  if (!textAreaFontFamilyEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitSliderIncrement()
{
...
void ResourcePaletteDialog::commitSliderChannel()
{
  if (!sliderChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitWheelSwitchPrecision()
{
  if (!wheelSwitchPrecisionEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitWheelSwitchFormat()
{
  if (!wheelSwitchFormatEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitWheelSwitchChannel()
{
  if (!wheelSwitchChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitChoiceButtonChannel()
{
  if (!choiceButtonChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitMenuChannel()
{
  if (!menuChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitMessageButtonLabel()
{
  if (!messageButtonLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitMessageButtonPressMessage()
{
  if (!messageButtonPressEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitMessageButtonReleaseMessage()
{
  if (!messageButtonReleaseEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitMessageButtonChannel()
{
  if (!messageButtonChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitShellCommandLabel()
{
  if (!shellCommandLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitShellCommandEntryLabel(int index)
{
...
void ResourcePaletteDialog::commitShellCommandEntryCommand(int index)
{
  if (index < 0 || index >= kShellCommandEntryCount) {
    return;
  }
...
void ResourcePaletteDialog::commitShellCommandEntryArgs(int index)
{
  if (index < 0 || index >= kShellCommandEntryCount) {
    return;
  }
...
void ResourcePaletteDialog::commitRelatedDisplayLabel()
{
  if (!relatedDisplayLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitRelatedDisplayEntryLabel(int index)
{
...
void ResourcePaletteDialog::commitRelatedDisplayEntryName(int index)
{
  if (index < 0 || index >= kRelatedDisplayEntryCount) {
    return;
  }
...
void ResourcePaletteDialog::commitRelatedDisplayEntryArgs(int index)
{
  if (index < 0 || index >= kRelatedDisplayEntryCount) {
    return;
  }
...
void ResourcePaletteDialog::commitPvTableColumns()
{
  if (!pvTableColumnsEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitPvTableFontSize(int value)
{
  if (!pvTableFontSizeSpin_) {
    return;
  }
...
void ResourcePaletteDialog::commitPvTableRowLabel(int index)
{
...
void ResourcePaletteDialog::commitPvTableRowChannel(int index)
{
...
void ResourcePaletteDialog::commitWaveTableFontSize(int value)
{
  if (!waveTableFontSizeSpin_) {
    return;
  }
...
void ResourcePaletteDialog::commitWaveTableChannel()
{
  if (!waveTableChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitWaveTableColumns()
{
  if (!waveTableColumnsEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitWaveTableMaxElements()
{
  if (!waveTableMaxElementsEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitTextMonitorChannel()
{
  if (!textMonitorChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitMeterChannel()
{
  if (!meterChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitBarChannel()
{
  if (!barChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitThermometerChannel()
{
  if (!thermometerChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitThermometerVisibilityCalc()
{
  if (!thermometerVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitThermometerVisibilityChannel(int index)
{
  if (index < 0
...
void ResourcePaletteDialog::commitScaleChannel()
{
  if (!scaleChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitStripChartTitle()
{
  if (!stripTitleEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitStripChartXLabel()
{
  if (!stripXLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitStripChartYLabel()
{
  if (!stripYLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitStripChartPeriod()
{
  if (!stripPeriodEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitStripChartChannel(int index)
{
...
void ResourcePaletteDialog::commitCartesianTitle()
{
  if (!cartesianTitleEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCartesianXLabel()
{
  if (!cartesianXLabelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCartesianYLabel(int index)
{
...
void ResourcePaletteDialog::commitCartesianCount()
{
  if (!cartesianCountEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCartesianTrigger()
{
  if (!cartesianTriggerEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCartesianErase()
{
  if (!cartesianEraseEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCartesianCountPv()
{
  if (!cartesianCountPvEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCartesianTraceXChannel(int index)
{
...
void ResourcePaletteDialog::commitCartesianTraceYChannel(int index)
{
...
void ResourcePaletteDialog::commitByteChannel()
{
  if (!byteChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitLedChannel()
{
  if (!ledChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitLedVisibilityCalc()
{
  if (!ledVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitLedVisibilityChannel(int index)
{
  if (index < 0
...
void ResourcePaletteDialog::commitLedStateCount(int value)
{
  if (!ledStateCountSpin_) {
    return;
  }
...
void ResourcePaletteDialog::commitExpressionChannelVariable()
{
  if (!expressionChannelVariableEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitExpressionChannelCalc()
{
  if (!expressionChannelCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitExpressionChannelChannel(int index)
{
  if (index < 0
...
void ResourcePaletteDialog::handleStripChartUnitsChanged(int index)
{
  if (!stripUnitsCombo_) {
    return;
  }
...
void ResourcePaletteDialog::handleCartesianStyleChanged(int index)
{
  if (!cartesianStyleCombo_) {
    return;
  }
...
void ResourcePaletteDialog::handleCartesianEraseOldestChanged(int index)
{
  if (!cartesianEraseOldestCombo_) {
    return;
  }
...
void ResourcePaletteDialog::handleCartesianEraseModeChanged(int index)
{
  if (!cartesianEraseModeCombo_) {
    return;
  }
...
void ResourcePaletteDialog::handleCartesianTraceAxisChanged(int index, int comboIndex)
{
...
void ResourcePaletteDialog::handleCartesianTraceSideChanged(int index, int comboIndex)
{
...
void ResourcePaletteDialog::openStripChartLimitsDialog(int index)
{
...
void ResourcePaletteDialog::updateStripChartPenLimitsFromDialog(int index)
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::commitByteStartBit(int value)
{
  if (!byteStartBitSpin_) {
    return;
  }
...
void ResourcePaletteDialog::commitByteEndBit(int value)
{
  if (!byteEndBitSpin_) {
    return;
  }
...
void ResourcePaletteDialog::updateSliderIncrementEdit()
{
  if (!sliderIncrementEdit_) {
    return;
  }
...
void ResourcePaletteDialog::updateWheelSwitchPrecisionEdit()
{
  if (!wheelSwitchPrecisionEdit_) {
    return;
  }
...
void ResourcePaletteDialog::updateTextMonitorLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateTextEntryLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateSetpointControlLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateTextAreaLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateSliderLimitsFromDialog()
{
  updateSliderIncrementEdit();
  if (!pvLimitsDialog_) {
    return;
...
void ResourcePaletteDialog::updateWheelSwitchLimitsFromDialog()
{
...
void ResourcePaletteDialog::updateMeterLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateBarLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateThermometerLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateScaleLimitsFromDialog()
{
  if (!pvLimitsDialog_) {
    return;
  }
...
void ResourcePaletteDialog::updateCartesianAxisButtonState()
{
...
void ResourcePaletteDialog::commitRectangleLineWidth()
{
  if (!rectangleLineWidthEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitRectangleVisibilityCalc()
{
  if (!rectangleVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitRectangleChannel(int index)
{
...
void ResourcePaletteDialog::commitCompositeFile()
{
  if (!compositeFileEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCompositeVisibilityCalc()
{
  if (!compositeVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitCompositeChannel(int index)
{
...
void ResourcePaletteDialog::commitImageName()
{
  if (!imageNameEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitImageCalc()
{
  if (!imageCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitImageVisibilityCalc()
{
  if (!imageVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitHeatmapDataChannel()
{
  if (!heatmapDataChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitHeatmapTitle()
{
  if (!heatmapTitleEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitHeatmapXDimension()
{
  if (!heatmapXDimEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitHeatmapYDimension()
{
  if (!heatmapYDimEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitHeatmapXDimensionChannel()
{
  if (!heatmapXDimChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitHeatmapYDimensionChannel()
{
  if (!heatmapYDimChannelEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitWaterfallXLabel()
{
...
void ResourcePaletteDialog::commitWaterfallYLabel()
{
...
void ResourcePaletteDialog::commitWaterfallDataChannel()
{
...
void ResourcePaletteDialog::commitWaterfallCountChannel()
{
...
void ResourcePaletteDialog::commitWaterfallTriggerChannel()
{
...
void ResourcePaletteDialog::commitWaterfallEraseChannel()
{
...
void ResourcePaletteDialog::commitWaterfallHistoryCount()
{
...
void ResourcePaletteDialog::commitWaterfallIntensityMinimum()
{
...
void ResourcePaletteDialog::commitWaterfallIntensityMaximum()
{
...
void ResourcePaletteDialog::commitWaterfallSamplePeriod()
{
...
void ResourcePaletteDialog::commitImageChannel(int index)
{
...
void ResourcePaletteDialog::commitLineLineWidth()
{
  if (!lineLineWidthEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitLineVisibilityCalc()
{
  if (!lineVisibilityCalcEdit_) {
    return;
  }
...
void ResourcePaletteDialog::commitLineChannel(int index)
{
...
Qt::Alignment ResourcePaletteDialog::alignmentFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::alignmentToIndex(Qt::Alignment alignment) const
{
...
TextMonitorFormat ResourcePaletteDialog::textMonitorFormatFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::textMonitorFormatToIndex(TextMonitorFormat format) const
{
  switch (format) {
...
TextAreaWrapMode ResourcePaletteDialog::textAreaWrapModeFromIndex(int index) const
{
  switch (index) {
  case 0:
...
int ResourcePaletteDialog::textAreaWrapModeToIndex(TextAreaWrapMode mode) const
{
  switch (mode) {
...
TextAreaCommitMode ResourcePaletteDialog::textAreaCommitModeFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::textAreaCommitModeToIndex(TextAreaCommitMode mode) const
{
  switch (mode) {
...
TextColorMode ResourcePaletteDialog::colorModeFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::colorModeToIndex(TextColorMode mode) const
{
  switch (mode) {
...
WaveTableLayout ResourcePaletteDialog::waveTableLayoutFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::waveTableLayoutToIndex(WaveTableLayout layout) const
{
  switch (layout) {
...
WaveTableValueFormat ResourcePaletteDialog::waveTableValueFormatFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::waveTableValueFormatToIndex(WaveTableValueFormat format) const
{
  switch (format) {
...
WaveTableCharMode ResourcePaletteDialog::waveTableCharModeFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::waveTableCharModeToIndex(WaveTableCharMode mode) const
{
  switch (mode) {
...
ResourcePaletteDialog::LedColorModeChoice
ResourcePaletteDialog::ledColorModeChoiceFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::ledColorModeChoiceToIndex(LedColorModeChoice choice) const
{
  switch (choice) {
...
ResourcePaletteDialog::LedColorModeChoice
ResourcePaletteDialog::ledColorModeChoiceForState(TextColorMode mode,
...
TextColorMode ResourcePaletteDialog::ledTextColorModeForChoice(LedColorModeChoice choice) const
{
  switch (choice) {
  case LedColorModeChoice::kAlarm:
    return TextColorMode::kAlarm;
...
HeatmapDimensionSource ResourcePaletteDialog::heatmapDimensionSourceFromIndex(int index) const
{
...
int ResourcePaletteDialog::heatmapDimensionSourceToIndex(HeatmapDimensionSource source) const
{
...
HeatmapOrder ResourcePaletteDialog::heatmapOrderFromIndex(int index) const
{
...
int ResourcePaletteDialog::heatmapOrderToIndex(HeatmapOrder order) const
{
...
HeatmapProfileMode ResourcePaletteDialog::heatmapProfileModeFromIndex(int index) const
{
...
bool ResourcePaletteDialog::heatmapBoolFromIndex(int index) const
{
  return index == 1;
}
...
int ResourcePaletteDialog::heatmapBoolToIndex(bool value) const
{
  return value ? 1 : 0;
}
...
MeterLabel ResourcePaletteDialog::meterLabelFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::meterLabelToIndex(MeterLabel label) const
{
  switch (label) {
...
BarDirection ResourcePaletteDialog::barDirectionFromIndex(int index) const
{
  switch (index) {
  case 0:
...
int ResourcePaletteDialog::barDirectionToIndex(BarDirection direction) const
{
  switch (direction) {
...
BarDirection ResourcePaletteDialog::scaleDirectionFromIndex(int index) const
{
  switch (index) {
  case 0:
    return BarDirection::kUp;
...
int ResourcePaletteDialog::scaleDirectionToIndex(BarDirection direction) const
{
...
BarFill ResourcePaletteDialog::barFillFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::barFillToIndex(BarFill fill) const
{
  switch (fill) {
...
LedShape ResourcePaletteDialog::ledShapeFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::ledShapeToIndex(LedShape shape) const
{
  switch (shape) {
...
TimeUnits ResourcePaletteDialog::timeUnitsFromIndex(int index) const
{
  switch (index) {
  case 0:
...
int ResourcePaletteDialog::timeUnitsToIndex(TimeUnits units) const
{
  switch (units) {
...
int ResourcePaletteDialog::cartesianPlotStyleToIndex(CartesianPlotStyle style) const
{
  switch (style) {
...
CartesianPlotStyle ResourcePaletteDialog::indexToCartesianPlotStyle(int index) const
{
  switch (index) {
  case 0:
...
int ResourcePaletteDialog::cartesianEraseModeToIndex(CartesianPlotEraseMode mode) const
{
  switch (mode) {
...
CartesianPlotEraseMode ResourcePaletteDialog::indexToCartesianPlotEraseMode(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::cartesianAxisToIndex(CartesianPlotYAxis axis) const
{
  switch (axis) {
...
CartesianPlotYAxis ResourcePaletteDialog::indexToCartesianAxis(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::degreesToAngle64(int degrees)
{
  return degrees * 64;
}

int ResourcePaletteDialog::angle64ToDegrees(int angle64)
{
  if (angle64 >= 0) {
...
TextVisibilityMode ResourcePaletteDialog::visibilityModeFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::visibilityModeToIndex(TextVisibilityMode mode) const
{
  switch (mode) {
...
RectangleFill ResourcePaletteDialog::fillFromIndex(int index) const
{
...
int ResourcePaletteDialog::fillToIndex(RectangleFill fill) const
{
...
RectangleLineStyle ResourcePaletteDialog::lineStyleFromIndex(int index) const
{
...
int ResourcePaletteDialog::lineStyleToIndex(RectangleLineStyle style) const
{
...
ImageType ResourcePaletteDialog::imageTypeFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::imageTypeToIndex(ImageType type) const
{
  switch (type) {
  case ImageType::kGif:
    return 1;
...
ExpressionChannelEventSignalMode ResourcePaletteDialog::expressionChannelEventSignalFromIndex(
    int index) const
{
  switch (index) {
  case 0:
...
int ResourcePaletteDialog::expressionChannelEventSignalToIndex(
...
ChoiceButtonStacking ResourcePaletteDialog::choiceButtonStackingFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::choiceButtonStackingToIndex(ChoiceButtonStacking stacking) const
{
  switch (stacking) {
...
RelatedDisplayVisual ResourcePaletteDialog::relatedDisplayVisualFromIndex(int index) const
{
  switch (index) {
  case 1:
...
int ResourcePaletteDialog::relatedDisplayVisualToIndex(RelatedDisplayVisual visual) const
{
  switch (visual) {
...
RelatedDisplayMode ResourcePaletteDialog::relatedDisplayModeFromIndex(int index) const
{
...
int ResourcePaletteDialog::relatedDisplayModeToIndex(RelatedDisplayMode mode) const
{
...
void ResourcePaletteDialog::showPaletteWithoutActivating()
{
...
void ResourcePaletteDialog::positionRelativeTo(QWidget *reference)
{
...
QScreen *ResourcePaletteDialog::screenForWidget(const QWidget *widget) const
{
  if (!widget) {
    return nullptr;
  }
...
void ResourcePaletteDialog::moveToTopRight(const QRect &area, const QSize &dialogSize)
{
  if (area.isNull()) {
    move(0, 0);
    return;
...
void ResourcePaletteDialog::resizeToFitContents(const QRect &available)
{
  if (entriesWidget_) {
...
void ResourcePaletteDialog::scheduleDeferredResize(QWidget *reference)
{
...
void ResourcePaletteDialog::setupGeometryField(QLineEdit *edit, GeometryField field)
{
  committedTexts_.insert(edit, edit->text());
  edit->installEventFilter(this);
  QObject::connect(edit, &QLineEdit::returnPressed, this,
...
void ResourcePaletteDialog::setupGridSpacingField(QLineEdit *edit)
{
  if (!edit) {
    return;
  }
...
void ResourcePaletteDialog::commitGeometryField(GeometryField field)
{
  if (!geometrySetter_) {
...
void ResourcePaletteDialog::revertLineEdit(QLineEdit *edit)
{
  if (!edit) {
    return;
  }
...
void ResourcePaletteDialog::updateGeometryEdits(const QRect &geometry)
{
  {
...
void ResourcePaletteDialog::updateCommittedTexts()
{
...
void ResourcePaletteDialog::commitGridSpacing()
{
  if (!gridSpacingEdit_) {
    return;
  }
...
QLineEdit *ResourcePaletteDialog::editForField(GeometryField field) const
{
  switch (field) {
  case GeometryField::kX:
    return xEdit_;
...
void ResourcePaletteDialog::openColorPalette(QPushButton *button, const QString &description,
...
bool ResourcePaletteDialog::positionColorPaletteRelativeToResource()
{
  if (!colorPaletteDialog_) {
    return false;
  }
...
void ResourcePaletteDialog::scheduleColorPalettePlacement()
{
  if (!colorPaletteDialog_) {
    return;
  }
...
bool ResourcePaletteDialog::placeColorPaletteRelativeToReference(ColorPaletteDialog *palette,
...
void ResourcePaletteDialog::openTextEntryPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openSetpointControlPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openTextAreaPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openTextMonitorPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openMeterPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openSliderPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openWheelSwitchPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openBarMonitorPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openThermometerPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openScaleMonitorPvLimitsDialog()
{
  PvLimitsDialog *dialog = ensurePvLimitsDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::openCartesianAxisDialog()
{
  CartesianAxisDialog *dialog = ensureCartesianAxisDialog();
  if (!dialog) {
    return;
...
void ResourcePaletteDialog::positionCartesianAxisDialog(CartesianAxisDialog *dialog)
{
  if (!dialog) {
    return;
  }
...
void ResourcePaletteDialog::positionPvLimitsDialog(PvLimitsDialog *dialog)
{
  if (!dialog) {
    return;
  }
...
QColor ResourcePaletteDialog::colorFromButton(const QPushButton *button) const
{
  if (!button) {
    return QColor();
  }
...
QColor ResourcePaletteDialog::currentForegroundColor() const
{
...
PvLimitsDialog *ResourcePaletteDialog::ensurePvLimitsDialog()
{
  if (!pvLimitsDialog_) {
...
CartesianAxisDialog *ResourcePaletteDialog::ensureCartesianAxisDialog()
{
  if (!cartesianAxisDialog_) {
...
QColor ResourcePaletteDialog::currentBackgroundColor() const
{
